...
public class DBAdapter {
	...
	private static final String DATABASE_CREATE = "create table userinfo (userid integer primary key autoincrement, "
			...
			+ "height text not null, topsize text not null, " 
			+ "waistsize text not null, favorite_color text not null);";
	...
	public long insertUserInfo(String username, String gender, String height, String topsize, String waistsize, String favorite_color) {
	...
	public Cursor getAllUserInfo() {
		return db.query(DATABASE_TABLE, new String[] { KEY_USERID, KEY_USERNAME,
				KEY_GENDER, KEY_HEIGHT, KEY_TOPSIZE, KEY_WAISTSIZE, KEY_FAVORITE_COLOR}, null, null, null, null, null);
	}

	// ---retrieves a particular userInfo---
	public Cursor getSingleUserInfo(long userId) throws SQLException {
		Cursor mCursor = db.query(true, DATABASE_TABLE, new String[] {
				KEY_USERID, KEY_USERNAME, KEY_GENDER, KEY_HEIGHT, KEY_TOPSIZE, KEY_WAISTSIZE, KEY_FAVORITE_COLOR}, KEY_USERID
	...
	public boolean updateUserInfo(long userId, String username, String gender,
			String height, String topsize, String waistsize, String favorite_color) {
